      ...
      <div class="container d-flex justify-content-between align-items-center">
        ...
        <nav id="navbar" class="navbar d-none d-lg-block">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-dark fw-bold current-page" href="Contact.html">CONTACT</a>
            </li>
          </ul>
        </nav>
  ...
  <ul class="nav flex-column text-center">
    ...
    <section class="hero">
      ...
      <video class="hero-bg1" autoplay loop muted playsinline>
        <source src="assets/img/ai-gen/PearlParticlesLoop.mp4 " type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      <h1 class="display-4 fw-bold spaced-letters">CONTACT</h1>
      <p class="lead glossy-background">
        Join our mission to empower everyone with the best in generativeAI.
      </p>
    </section>
    <!-- Get Involve Section -->
    <section class="py-5 introA" id="getInvolved">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <h2 class="custom-margin-top" >Get Involved</h2>
            <ul>
              <li>Cook Employees: Access our internal SharePoint site to join LoopTech and contribute to our mission.
             </li>
             <li>General Inquiries: We're open to partnerships and collaborations. Feel free to reach out!</li>
            </ul>
          </div>
        </div>
      </div>
    </section>
<!-- Contact Us Form Section test
      ...
      <div class="col-lg-8">
        ...
        >
          ...
          <div class="my-3">
            ...
            <div class="error-message" style="display: none;">Something went wrong.</div>
...
<section class="py-5 bg-dark" id="contactUs">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
...
<section class="persistent-contact py-5" id="contactInfo">
  <div class="container text-center position-relative">
    <img
    src="assets/img/images/Cook.jpg"
    alt="Introduction Image"
    class="img-fluid rounded"
  />
  <div class="text-box py-5">
    <h2>Persistent Contact Information</h2>
    <p>Address: LoopTech, 750 Daniels Way, Bloomington, IN</p>
  </div>
  </div>
</section>

<!-- Follow Us Section -->
<section class="social-section py-5 bg-dark " id="social">
  <div class="container text-center">
  <img
  src="assets/img/images/elliott_looptech_81436_contact_us_image_with_google_facebook__3a9c6ea5-cd5a-430c-a5c3-bfa4f08ca54a_0.png"
  alt="Introduction Image"
  class="img-fluid rounded"
/>
 <div class="text-box py-5 bg-dark">
  <h2>Follow Us Everywhere Else</h2>
  <div class="social-icons mt-3">
  <!--   <a href="#" class="social-icon me-3"><i class="bi bi-google"></i></a>
